...
namespace AK
{
    namespace EVENTS
    {
        ...
        static const AkUniqueID PLAY_ROLL_BLEND_CONTAINER = 4208395867U;
    ...
    namespace SWITCHES
    {
        namespace ENVIRONMENT
        {
            ...
            namespace SWITCH
            {
                static const AkUniqueID GRAVE_YARD = 1905655063U;
                static const AkUniqueID NORMAL_WOODS = 1300150859U;
            } // namespace SWITCH
        } // namespace ENVIRONMENT
